		...
		try 
		{
			...
			else
			{
				...
				if ($wszystko_OK==true)
				{
					...
					if ($polaczenie->query("INSERT INTO `DZadanieG`(`id`, `idproj`, `nazwa`, `opis`, `punkty`, `priorytet`, `dedline`, `status`, `link`) VALUES (NULL,'$idprojektu','$nazwa','$opis','$punkty','$priorytet','$dedline','DODANO',NULL)"))
					{
